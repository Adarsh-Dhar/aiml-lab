...
def main():
    ...
    plt.subplot(1, 2, 1)
    plot_decision_boundaries(X_train, y_train, model_relu, 'Decision Boundaries with ReLU')

    plt.subplot(1, 2, 2)
    plot_decision_boundaries(X_train, y_train, model_tanh, 'Decision Boundaries with Tanh')
